  ...
  return (
    ...
    >
      <div className="h-64 bg-[var(--canvas-soft)] relative overflow-hidden border-b border-[var(--hairline-soft)] rounded-t-[19px] isolate">
        ...
        <button 
          onClick={onDelete}
          className="absolute top-4 right-4 z-20 p-2.5 bg-[var(--surface-card)] backdrop-blur-md rounded-full text-[var(--muted)] hover:text-red-500 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all shadow-sm border border-[var(--hairline)]"
